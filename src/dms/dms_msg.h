...
typedef enum en_msg_command {
    ...
    MSG_REQ_BUF_RES_DRC_REBUILD = 27,
    MSG_REQ_LOCK_RES_DRC_REBUILD = 28,
    ...
    MSG_REQ_OPENGAUSS_LOCK_BUFFER = 34,
    MSG_REQ_ASK_EDP_REMOTE = 35,
    MSG_REQ_SYNC_STEP = 36,
    MSG_REQ_SYNC_SHARE_INFO = 37,
