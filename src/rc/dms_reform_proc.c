...
dms_reform_proc_t g_dms_reform_procs[DMS_REFORM_STEP_COUNT] = {
    ...
    [DMS_REFORM_STEP_DRC_RCY_CLEAN] = { "DRC_RCY_CLEAN", dms_reform_drc_rcy_clean, dms_reform_drc_rcy_clean_parallel, CM_TRUE },
    [DMS_REFORM_STEP_CTL_RCY_CLEAN] = { "CTL_RCY_CLEAN", dms_reform_ctl_rcy_clean, dms_reform_ctl_rcy_clean_parallel, CM_FALSE },
