...
drps_desc_t g_drps_desc_t[DRPS_COUNT] = {
    ...
    {DRPS_DRC_CLEAN_NO_OWNER,                       DRPS_LEVEL_ONE,     "NO_OWNER"},
    {DRPS_DRC_CLEAN_NO_CVT,                         DRPS_LEVEL_ONE,     "NO_CVT"},
    {DRPS_DRC_CLEAN_CONFIRM_COPY,                   DRPS_LEVEL_ONE,     "CONFIRM_COPY"},
    {DRPS_DRC_CLEAN_OWNER_CVT_FAULT,                DRPS_LEVEL_ONE,     "BOTH_FAULT"},
    {DRPS_DRC_CLEAN_CONFIRM_OWNER,                  DRPS_LEVEL_ONE,     "CONFIRM_OWNER"},
    {DRPS_DRC_CLEAN_CONFIRM_CVT,                    DRPS_LEVEL_ONE,     "CONFIRM_CVT"},
    ...
    {DRPS_DRC_REPAIR_NEED_FLUSH,                    DRPS_LEVEL_ONE,     "NEED_FLUSH"},
    {DRPS_DRC_REPAIR_NEED_NOT_FLUSH,                DRPS_LEVEL_ONE,     "NOT_FLUSH"},
    {DRPS_DRC_REPAIR_WITH_COPY,                     DRPS_LEVEL_ONE,     "WITH_COPY"},
    {DRPS_DRC_REPAIR_WITH_COPY_NEED_FLUSH,          DRPS_LEVEL_TWO,   "COPY_NEED_FLUSH"},
    {DRPS_DRC_REPAIR_WITH_LAST_EDP,                 DRPS_LEVEL_ONE,     "WITH_LAST_EDP"},
    {DRPS_DRC_REPAIR_WITH_EDP_MAP,                  DRPS_LEVEL_ONE,     "WITH_EDP_MAP"},
    {DMS_REFORM_STEP_RECOVERY_ANALYSE,              DRPS_LEVEL_TOP,     "RECOVERY_ANALYSE"},
    {DMS_REFORM_STEP_FLUSH_COPY,                    DRPS_LEVEL_TOP,     "FLUSH_COPY"},
    {DRPS_DRC_FLUSH_COPY_LOCAL,                     DRPS_LEVEL_ONE,     "LOCAL"},
    {DRPS_DRC_FLUSH_COPY_REMOTE,                    DRPS_LEVEL_ONE,     "REMOTE"},
    {DRPS_DRC_EDP_TO_OWNER_LOCAL,                   DRPS_LEVEL_ONE,     "EDP_LOCAL"},
    {DRPS_DRC_EDP_TO_OWNER_REMOTE,                  DRPS_LEVEL_ONE,     "EDP_REMOTE"},
...
{
    drps_item_t *drps_item = &drps_items->drps_item[DRPS_REFORM];
