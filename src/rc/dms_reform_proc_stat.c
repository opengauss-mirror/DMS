...
drps_desc_t g_drps_desc_t[] = {
    ...
    {DRPS_CALLBACK_STAT_ENTRY_TLOCK,                            DRPS_LEVEL_TWO,     "ENTRY_LOCK"},
    {DRPS_CALLBACK_STAT_PART_ENTRY_TLOCK,                       DRPS_LEVEL_TWO,     "PART_ENTRY_LOCK"},
    ...
    {DRPS_VALIDATE_LOCK_MODE_TLOCK,                             DRPS_LEVEL_ONE,     "TABLE_LOCK"},
    {DRPS_VALIDATE_LOCK_MODE_TLOCK_LOCAL,                       DRPS_LEVEL_TWO,     "TABLE_LOCK_LOCAL"},
    {DRPS_VALIDATE_LOCK_MODE_TLOCK_REMOTE,                      DRPS_LEVEL_TWO,     "TABLE_LOCK_REMOTE"},
    ...
    {DRPS_CALLBACK_STAT_VALIDATE_DRC_TLOCK_REMOTE,              DRPS_LEVEL_TWO,     "TLOCK_REMOTE_REST"},
