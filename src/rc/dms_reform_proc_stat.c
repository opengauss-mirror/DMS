...
drps_desc_t g_drps_desc_t[DRPS_COUNT] = {
    ...
    {DMS_REFORM_STEP_FILE_ORGLSN_RECOVERY_PART1,    DRPS_LEVEL_ONE,     "FILE_ORGLSN_RCY_PART1"},
    {DMS_REFORM_STEP_FILE_ORGLSN_RECOVERY_PART2,    DRPS_LEVEL_ONE,     "FILE_ORGLSN_RCY_PART2"},
