...
drps_desc_t g_drps_desc_t[] = {
    ...
    {DRPS_DRC_REBUILD_TABLE_LOCK,                               DRPS_LEVEL_ONE,     "TABLE LOCK"},
    {DRPS_DRC_REBUILD_TLOCK_LOCAL,                              DRPS_LEVEL_TWO,     "TABLE LOCK LOCAL"},
    {DRPS_DRC_REBUILD_TLOCK_REMOTE,                             DRPS_LEVEL_TWO,     "TABLE LOCK REMOTE"},
    {DRPS_CALLBACK_STAT_ENTRY_TLOCK,                            DRPS_LEVEL_TWO,     "ENTRY_TLOCK"},
    {DRPS_CALLBACK_STAT_PART_ENTRY_TLOCK,                       DRPS_LEVEL_TWO,     "PART_ENTRY_TLOCK"},
    {DRPS_CALLBACK_STAT_TLOCK_REMOTE,                           DRPS_LEVEL_TWO,     "TABLE LOCK REMOTE_REST"},
    ...
    {DRPS_VALIDATE_LOCK_MODE_TLOCK,                             DRPS_LEVEL_ONE,     "TABLE LOCK"},
    {DRPS_VALIDATE_LOCK_MODE_TLOCK_LOCAL,                       DRPS_LEVEL_TWO,     "TABLE LOCK LOCAL"},
    {DRPS_VALIDATE_LOCK_MODE_TLOCK_REMOTE,                      DRPS_LEVEL_TWO,     "TABLE LOCK REMOTE"},
    {DRPS_CALLBACK_STAT_VALIDATE_DRC_ENTRY_TLOCK,               DRPS_LEVEL_TWO,     "ENTRY_TLOCK"},
    {DRPS_CALLBACK_STAT_VALIDATE_DRC_PART_ENTRY_TLOCK,          DRPS_LEVEL_TWO,     "PART_ENTRY_TLOCK"},
    {DRPS_CALLBACK_STAT_VALIDATE_DRC_TLOCK_REMOTE,              DRPS_LEVEL_TWO,     "TABLE LOCK REMOTE_REST"},
...
dms_reform_proc_stat_e g_callback_stat_map[REFORM_CALLBACK_STAT_COUNT] = {
    ...
    [REFORM_CALLBACK_STAT_ENTRY_TLOCK] = DRPS_CALLBACK_STAT_ENTRY_TLOCK,
    [REFORM_CALLBACK_STAT_PART_ENTRY_TLOCK] = DRPS_CALLBACK_STAT_PART_ENTRY_TLOCK,
    ...
    [REFORM_CALLBACK_STAT_VALIDATE_DRC_ENTRY_TLOCK] = DRPS_CALLBACK_STAT_VALIDATE_DRC_ENTRY_TLOCK,
    [REFORM_CALLBACK_STAT_VALIDATE_DRC_PART_ENTRY_TLOCK] = DRPS_CALLBACK_STAT_VALIDATE_DRC_PART_ENTRY_TLOCK,
    [REFORM_CALLBACK_STAT_VALIDATE_DRC_TLOCK_REMOTE] = DRPS_CALLBACK_STAT_VALIDATE_DRC_TLOCK_REMOTE,
