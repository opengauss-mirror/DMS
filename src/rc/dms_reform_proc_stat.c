...
drps_desc_t g_drps_desc_t[] = {
    ...
    {DRPS_VALIDATE_LOCK_MODE_WAIT_LATCH,                        DRPS_LEVEL_ONE,     "WAIT_LATCH"},
    ...
    {DRPS_VALIDATE_LOCK_MODE_ALOCK,                             DRPS_LEVEL_ONE,     "ALOCK"},
    {DRPS_VALIDATE_LOCK_MODE_ALOCK_LOCAL,                       DRPS_LEVEL_TWO,     "ALOCK_LOCAL"},
    {DRPS_VALIDATE_LOCK_MODE_ALOCK_REMOTE,                      DRPS_LEVEL_TWO,     "ALOCK_REMOTE"},
    {DRPS_CALLBACK_STAT_VALIDATE_ALOCK_LOCAL,                   DRPS_LEVEL_TWO,     "CB_ALOCK_LOCAL"},
    {DRPS_CALLBACK_STAT_VALIDATE_DRC_ALOCK_REMOTE,              DRPS_LEVEL_TWO,     "CB_ALOCK_REMOTE_REST"},
...
dms_reform_proc_stat_e g_callback_stat_map[REFORM_CALLBACK_STAT_COUNT] = {
    ...
    [REFORM_CALLBACK_STAT_VALIDATE_ALOCK_LOCAL] = DRPS_CALLBACK_STAT_VALIDATE_ALOCK_LOCAL,
    [REFORM_CALLBACK_STAT_VALIDATE_DRC_ALOCK_REMOTE] = DRPS_CALLBACK_STAT_VALIDATE_DRC_ALOCK_REMOTE,
};
