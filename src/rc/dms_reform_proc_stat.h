...
typedef enum en_dms_reform_proc_stat {
    ...
    DRPS_VALIDATE_LOCK_MODE_ALOCK,
    DRPS_VALIDATE_LOCK_MODE_ALOCK_LOCAL,
    DRPS_VALIDATE_LOCK_MODE_ALOCK_REMOTE,
    ...
    DRPS_CALLBACK_STAT_VALIDATE_ALOCK_LOCAL,
    DRPS_CALLBACK_STAT_VALIDATE_DRC_ALOCK_REMOTE,
