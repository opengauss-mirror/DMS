...
typedef enum en_dms_reform_proc_stat {
    ...
    DRPS_CALLBACK_STAT_ENTRY_TLOCK,
    DRPS_CALLBACK_STAT_PART_ENTRY_TLOCK,
    ...
    DRPS_CALLBACK_STAT_VALIDATE_DRC_ENTRY_TLOCK,
    DRPS_CALLBACK_STAT_VALIDATE_DRC_PART_ENTRY_TLOCK,
